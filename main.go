...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c6f3733e.example.com",
	})
	if err != nil {
	...
	resourceList := []string{
		kubedbapi.ResourceKindMongoDB,
		kubedbapi.ResourceKindPostgres,
		kubedbapi.ResourceKindRedis,
		kubedbapi.ResourceKindMySQL,
		kubedbapi.ResourceKindMariaDB,
		kubedbapi.ResourceKindElasticsearch,
	}
